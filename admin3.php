...
$q1=mysql_query("select * from parking where vehicle='$vehicle' &&  status=0  && vip='1' order by park_id limit 0,1");
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td align="center" valign="top"><p><strong>VIP Parking </strong></p>
        <p>Select Vehicle
        <select name="vehicle">
          <option>-Vehicle-</option>
		  <?php
		  $q2=mysql_query("select distinct(vehicle) as vehicle from parking where vip=1");
while($r2=mysql_fetch_array($q2))
{
		  ?>
          <option <?php if($vehicle==$r2['vehicle']) echo "selected"; ?>><?php echo $r2['vehicle'];?></option>
   <?php
   }
   ?>
        </select>
	  ...
	  <table width="927" height="210" border="0">
        <tr>
          <td align="center"><table width="283" height="171" border="0" cellpadding="5" cellspacing="0" class="border">
            ...
            <tr>
              <td align="center"><input name="btn1" type="submit" value="Entry" /></td>
            </tr>
          </table></td>
          <td align="center"><table width="235" height="171" border="0" cellpadding="5" cellspacing="0" class="border">
            ...
            <tr>
              <td><input type="text" name="cno2" value="<?php echo $_REQUEST['cno2']; ?>">
                <input type="submit" name="btn3" value="Submit"></td>
            </tr>
            <tr>
              <td align="center"><?php
			  if(isset($btn3))
