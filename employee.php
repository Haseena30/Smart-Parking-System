  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="76%" align="center" valign="top"><p>&nbsp;</p>
        <h3>EMPLOYEE BIKE PARKING </h3>
        <?php
$q1=mysql_query("select * from parking where vehicle='Bike' && emp='1'");
...
<table width="759" height="238" border="1" cellpadding="5" cellspacing="0">
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><a href="employee2.php">Click to Employee Car Parking</a> </p></td>
      <td width="24%" align="center" valign="top"><p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><img src="images/bajaj_ktm_bike_125cc.jpg" width="295" height="178"></p>
        <p>&nbsp;</p>
        <p><img src="images/imagesbike.jpeg" width="300" height="168"></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p></td>
    </tr>
    <tr>
