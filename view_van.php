  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="76%" align="center" valign="top"><p>&nbsp;</p>
        <h3>VAN PARKING </h3>
        <?php
$q1=mysql_query("select * from parking where vehicle='Van' && emp='0' && vip='0'");
...
<table width="759" height="238" border="1" cellpadding="5" cellspacing="0">
      ...
      <td width="24%" align="center" valign="top"><p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><img src="images/van.jpg" width="259" height="194"></p>
        <p>&nbsp;</p>
        <p><img src="images/van2.jpg" width="259" height="194"></p></td>
    </tr>
    <tr>
