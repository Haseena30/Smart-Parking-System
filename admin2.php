...
$q1=mysql_query("select * from parking where vehicle='$vehicle' &&  status=0  && emp='1' order by park_id limit 0,1");
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td align="center" valign="top"><p><strong>Employee Parking </strong></p>
        <p>Select Vehicle
        <select name="vehicle">
